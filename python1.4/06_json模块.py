...
#前端的json和python中的字典有啥区别
#{"id": 1, "islogin": true, "hasGril": null}
# d={"id":1,"islogin":True,"hasGril":None}
# print(json.dumps(d))
